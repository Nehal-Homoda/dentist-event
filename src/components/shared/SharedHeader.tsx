...
export default function SharedHeader({ pageName }: Props) {
    return (
        <div className="relative w-full lg:h-[500px] h-[350px] aspect-[1/0.7] bg-[url('@/assets/images/bg/header-img.png')] bg-no-repeat bg-cover flex flex-col justify-end items-center lg:pb-24 pb-14">
                <img
