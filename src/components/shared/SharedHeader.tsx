...
export default function SharedHeader({ pageName }: Props) {
    return (
        <div style={{backgroundImage:`url('${bg.header_img_bg.src}')`}}  className="relative w-full lg:h-[425px] h-[350px]  bg-no-repeat bg-center bg-cover flex flex-col justify-end items-center lg:pb-16 pb-14">
                <img
